...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?= form_input('NOME', $funcionario['NOME'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Apelido:</label>
    <div class="col-sm-9">
        <?= form_input('APELIDO', $funcionario['APELIDO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?= form_input('NURG', $funcionario['NURG'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">CPF:</label>
    <div class="col-sm-9">
        <?= form_input('NUCPF', $funcionario['NUCPF'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">CEP:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[CEP]', $funcionario['ENDERECO']['CEP'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Logradouro:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[LOGRADOURO]', $funcionario['ENDERECO']['LOGRADOURO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Complemento:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[COMPLEMENTO]', $funcionario['ENDERECO']['COMPLEMENTO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Nº:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[NUMERO]', $funcionario['ENDERECO']['NUMERO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Bairro:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[BAIRRO]', $funcionario['ENDERECO']['BAIRRO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Cidade:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[CIDADE]', $funcionario['ENDERECO']['CIDADE'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">UF:</label>
    <div class="col-sm-9">
        <?= form_input('ENDERECO[UF]', $funcionario['ENDERECO']['UF'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Celular:</label>
    <div class="col-sm-9">
        <?= form_input('NUCELULAR', $funcionario['NUCELULAR'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?= form_date('DTREGISTRO', $funcionario['DTREGISTRO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Adimissão:</label>
    <div class="col-sm-9">
        <?= form_date('DTADMISSAO', $funcionario['DTADMISSAO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Nascimento:</label>
    <div class="col-sm-9">
        <?= form_date('DTNASCIMENTO', $funcionario['DTNASCIMENTO'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Cart. saúde:</label>
    <div class="col-sm-9">
        <?= form_date('DTCARTSAUDE', $funcionario['DTCARTSAUDE'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?= form_input('USUARIOPANTERA', $funcionario['USUARIOPANTERA'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label">Senha Pantera:</label>
    <div class="col-sm-9">
        <?= form_input('SENHAPANTERA', $funcionario['SENHAPANTERA'], ['class' => 'form-control', "required" => TRUE]) ?>
    </div>
</div>
<div class="form-group">
