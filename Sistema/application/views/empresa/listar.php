        ...
        <div class="panel-body" style="background: #fbfbfb; "> 
            ...
            <div class="row">
                <div class="col-xs-12" style="margin-top: 15px">
                    <input type="text" id="text_search" onchange="pesquisar('empresa','ativo_search')" class="form-control input-sm pull-left" style="margin-left: 5px;max-width: 200px;" placeholder="Procurar"/>
                    <div class="checkbox-inline">
                        <label style="margin-top: 3px;margin-bottom: 0;">
                            <input type="checkbox" id="ativo_search" onchange="pesquisar('empresa','ativo_search')" class="checkbox_lista input-table"  value="S" checked style="position: initial;float: left;"> Somente ativos
                        </label>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div  class="panel panel-primary modal-content">
            <div class="modal-header panel-heading" >
                ...
                <h4 class="modal-title" id="modal-title">Empresa</h4>
            </div>
